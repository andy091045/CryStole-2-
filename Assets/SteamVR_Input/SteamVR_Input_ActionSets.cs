...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_ChangeWeapon p_ChangeWeapon;
        ...
        public static SteamVR_Input_ActionSet_ChangeWeapon ChangeWeapon
        {
            get
            {
                return SteamVR_Actions.p_ChangeWeapon.GetCopy<SteamVR_Input_ActionSet_ChangeWeapon>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_ChangeWeapon = ((SteamVR_Input_ActionSet_ChangeWeapon)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_ChangeWeapon>("/actions/ChangeWeapon")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.ChangeWeapon};
        }
    }
}
